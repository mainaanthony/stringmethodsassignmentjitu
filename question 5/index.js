...
//     console.log("Correct, your word is a palindrome")
//   }else{
//     console.log("Try again to guess a palindrome")
//   }
...
function reverse(enterWord){
    
      const splitWord = String(enterWord).split('')
    ...
    return joinReverseSplitWords
  
}

console.log(reverse('abc'))
console.log(reverse('JavaScript Exercises'))
